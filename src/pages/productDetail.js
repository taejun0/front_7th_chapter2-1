...
function createBreadcrumb(category1, category2) {
  let breadcrumb = `<a href="/" data-link="" class="hover:text-blue-600 transition-colors">홈</a>`;
        ...
        <main class="max-w-md mx-auto px-4 py-4">
          ...
          <nav class="mb-4">
            <div class="flex items-center space-x-2 text-sm text-gray-600">
              ${createBreadcrumb(product.category1, product.category2)}
            </div>
          </nav>
          <!-- 상품 상세 정보 -->
            ...
            <div class="p-4">
              ...
              <div>
                ...
                <div class="flex items-center mb-3">
                  ...
                  <span class="ml-2 text-sm text-gray-600">${product.rating} ${product.reviewCount ? `(${product.reviewCount}개 리뷰)` : ""}</span>
                </div>
                `
                    : ""
                }
            ...
            <div class="border-t border-gray-200 p-4">
              <div class="flex items-center justify-between mb-4">
                ...
                <div class="flex items-center">
                  ...
                  <input type="number" id="quantity-input" value="1" min="1" ${product.stock ? `max="${product.stock}"` : ""} class="w-16 h-8 text-center text-sm border-t border-b border-gray-300 
